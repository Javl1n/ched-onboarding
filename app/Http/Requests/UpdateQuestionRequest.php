...
class UpdateQuestionRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge(['original_for' => $question->for]);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'for' => ['required', 'in:trainee,supervisor', 'same:original_for'],
    ...
    public function messages(): array
    {
        return [
            ...
            'for.same' => 'You cannot change who the question is for after creation.',
