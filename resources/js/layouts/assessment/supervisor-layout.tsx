...
export default function SupervisorAssessmentLayout({ children, actions }: PropsWithChildren & { actions?: ReactNode }) {
    ...
    return (
        <div className="max-h-[calc(100vh-50px)] overflow-clip px-4 py-6">
            ...
            <div className="flex flex-col lg:flex-row lg:space-x-12">
                ...
                <div className="h-[calc(80vh)] flex-1 overflow-scroll pb-4">
                    <section className="mx-4 space-y-12">{children}</section>
                </div>
            </div>
        </div>
    );
