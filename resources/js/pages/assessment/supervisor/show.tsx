...
export default function SupervisorAsssessmentShow({
     supervisor, questions: questionList, assessments: assessmentList
}: {
     supervisor: User,
     ...
     return (
          <AppLayout>
               ...
               <SupervisorAssessmentLayout actions={
                    <>
                         <Button disabled={processing} onClick={save} className="w-full">Save Assessment</Button>
                    </>
               }>
                    <>
