        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <OnboardingLayout>
                <div className="space-y-6">
                    ...
                    <div className="rounded-xl border border-sidebar-border bg-gradient-to-br from-white via-blue-50/50 to-indigo-50/50 px-6 pb-6 shadow-md dark:from-card dark:via-blue-950/10 dark:to-indigo-950/10 sm:px-8 sm:pb-8 lg:px-10 lg:pb-10 pt-10">
