        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4 lg:p-6">
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    {/* Total Trainees */}
                    <div className="group relative min-w-[180px] flex-1 overflow-hidden rounded-xl border border-sidebar-border bg-card p-4 shadow-sm transition-all hover:shadow-md">
                ...
                <div className="rounded-xl border border-sidebar-border bg-card p-6 shadow-sm">
                    ...
                    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        {Object.keys(departmentsCount).map((department) => (
                            <div
                                key={department}
                                className="flex items-center justify-between rounded-lg border border-sidebar-border bg-muted/30 p-4 transition-all hover:border-sidebar-border/70 hover:bg-muted/50"
                            >
                                <div className="flex-1">
