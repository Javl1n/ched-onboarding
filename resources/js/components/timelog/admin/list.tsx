                ...
                <TableBody>
                    {logs.map((log, index) => (
                        <TableRow onClick={() => router.visit(show.log(log.trainee.user).url)} key={index}>
                            ...
                            <TableCell>
                                {time(log.morning_in)} - {time(log.morning_out)} {hours(log.morning_in, log.morning_out)}
                            </TableCell>
                            <TableCell>
                                {time(log.afternoon_in)} - {time(log.afternoon_out)} {hours(log.afternoon_in, log.afternoon_out)}
                            </TableCell>
