...
class QuestionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $scales = [
            'Quality of Work' => [
                'The OJT trainee consistently completes assigned tasks in accordance with operational standards, ensuring that work is accurate, error-free, and aligned with the office quality requirements.',
                ...
                'The OJT trainee presents work in a neat, organized, and professional manner, following proper formatting and documentation practice to ensure clarity and readability.',
            ...
            'Productivity' => [
                ...
                'The OJT trainee demonstrates the useful and effective application of acquired knowledge and skills by performing tasks competently, solving problems effectively, and adapting learned techniques to various work situations.',
            ...
            'Work Habits, Talents & Skills' => [
                ...
                'The OJT trainee communicates effectively with guests, supervisors, and colleagues by using clear, respectful, and professional language in both verbal and written forms.',
            ...
            'Interpersonal Work Relationship' => [
                "The OJT trainee demonstrates a positive relationship with the establishment's workers by showing respect, maintaining professionalism, and fostering a harmonious work environment.",

                'The OJT trainee relates effectively with visitors by being friendly, approachable, and courteous at all times.',
                ...
                'The OJT trainee shows respect for diversity by valuing differences in background, perspectives, and working styles, and by promoting inclusivity in the workplace.',
            ],
        ];
